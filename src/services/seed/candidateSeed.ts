...
export const stages: Candidate['stage'][] = ['applied', 'screen', 'tech', 'offer', 'hired', 'rejected'];
...
const jobIds = Array.from({ length: 35 }, (_, i) => `job-${i + 1}`);

export const candidatesSeed: Candidate[] = Array.from({ length: 1200 }, 
