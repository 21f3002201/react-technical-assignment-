const SimpleJobSkeleton = () => {
  return (
    ...
    <div className="h-10 bg-purple-200 rounded w-28"></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {[...Array(6)].map((_, i) => (
          <div key={i} className="bg-white p-6 rounded-xl shadow-lg border border-purple-200">
            <div className="space-y-3">
              ...
              {/* Tags */}
              <div className="flex gap-2">
                <div className="h-5 bg-purple-200 rounded w-16"></div>
                <div className="h-5 bg-purple-200 rounded w-20"></div>
                <div className="h-5 bg-purple-200 rounded w-12"></div>
              </div>
