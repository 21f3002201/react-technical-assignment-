...
const Candidates: React.FC = () => {
  ...
  const stages = [
    ...
    { key: "screen", label: "Screen", color: "bg-purple-200 text-purple-900" },
    {
      key: "tech",
      label: "Tech Interview",
      color: "bg-purple-300 text-purple-900",
    },
    { key: "offer", label: "Offer", color: "bg-purple-400 text-purple-900" },
    { key: "hired", label: "Hired", color: "bg-purple-500 text-white" },
  ...
  const fetchCandidates = async () => {
    try {
      ...
      console.log("Fetched candidates:", response.data.data); // TEMP DEBUG
      ...
      {view === "list" ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-3 gap-6">
          {stages.map((stage) => (
            ...
            >
              <div className="p-8 border-b border-gray-200 flex flex-col items-center justify-center min-h-[110px]">
                <div className="flex flex-col items-center w-full">
                  ...
                  <div className="w-full text-center">
                    <span
                      className={`px-4 py-2 text-lg font-semibold rounded-full ${stage.color}`}
                    >
